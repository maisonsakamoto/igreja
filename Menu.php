...
<style>
    ...
    .menu li a:before {font-family: FontAwesome; speak: none; text-indent: 0em; position: absolute; top: 0; left: 0; width: 100%; height: 100%; font-size: 1.4em;}
    ...
    <tr>
        <td>
                    <ul class="menu">
                         ...
                         <li title="Menu Barrinha"><a href="#" class="menu-button home">menu</a></li>
