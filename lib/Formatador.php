...
class Formatador{
    ...
    /**
     * Passe o string com carcter estranho e retorna certo para inserir no Firebird
     * Receba a string  carcter estranho
     * @param string
     * @return certo para o Mysql
     */
    public static function scapeBlobParaFirebird($v){
        //$a = array("'","'");
        //$b = array("''","''");
        $v = strtr(strtoupper($v), array(
                "ã" => "Ã", "à" => "À", "è" => "È", "ì" => "Ì", "ò" => "Ò", "ù" => "Ù", "á" => "Á", "é" => "É", "í" => "Í",
     ...
     * @return certo para o Mysql
     */
    public static function scapeParaFirebird($v){
        //$a = array("'","'");
        //$b = array("''","''");
        $v = strtr(strtoupper($v), array(
                "ã" => "Ã", "à" => "À", "è" => "È", "ì" => "Ì", "ò" => "Ò", "ù" => "Ù", "á" => "Á", "é" => "É", "í" => "Í",
     ...
     * @return string
     */
    public static function espacoEsquerda($str,$int){
        $tam = strlen($str);
        for ($index = $tam; $index < $int; $index++) {
            $str = " ".$str;
        }
    ...
    public static function dateEmSQL($dateSql){
        $ano= substr($dateSql, 0,-6);
        $mes= substr($dateSql, 5,-3);
        $dia= substr($dateSql, 8);
        return $dia."/".$mes."/".$ano;
