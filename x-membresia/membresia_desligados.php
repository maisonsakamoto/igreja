...
.jqx-grid-cell-selected{ background: #9BCD9B; }
    ...
    #bt_novo_membro:hover, #bt_editar_membro:hover,  #bt_desliga_membro:hover{cursor: pointer; background: #CFCFCF; color: black; }
    #bt_novo_membro, #bt_editar_membro, #bt_desliga_membro {background: #FFFFE0; width: 140px; font: 12px verdana; height: 30px; color: black; }  
...
<div class="container"  style="background: #FAEBD7; height: 690px; width: 1000px; float: left;">  
    ...
    $o = new OpenDB();
    $link = $o->server();
    $style_titulo="style='background-color: #CD3333; height: 25px; border:1px; border-color:red; font-family:verdana; font-size: 10px; color: white; font-weight:bold'"; 
    echo "<table>";
        echo "<tr $style_titulo>";
           echo "<td style='width: 995px;text-align:center; '>RELAÇÃO DE MEMBROS DESLIGADOS</td>";
        echo "</tr>";
    ...
    /*echo "<table>";
        ...
        echo "</tr>";        */
    echo "</table>";          
        $query = "select * from membresia where uso_ibr_desligamento is not null order by nome";
...
<script type="text/javascript">
    ...
    var principal_membresia = {};
    principal_membresia.arrayMembros=new Array();
    principal_membresia.start=function(){
        principal_membresia.html();
        principal_membresia.eventos(); // EXECUTA A FUNCAO EVENTOS, CONFIGURA OQUE OS CLIQUES IRÁ FAZER        
       ...
       /* $('#bt_editar_membro').attr('nr_id',$("#nr_id").val());
        ...
        principal_membresia.setGridMembro();
    }; 
    
    principal_membresia.setGridMembro = function(){
        $('#tab_membro').find('tr').each( function(){
           ...
           //principal_membresia.arrayMembros.push( { id:id, nome: nome_membro } );
           principal_membresia.arrayMembros.push( obj );           
        });
         var source = { localdata: principal_membresia.arrayMembros };
        ...
        principal_membresia.eventos=function(){
            ...
            $('#bt_desliga_membro').click(function(){      
                ...
                window.esconde_botoes();
                var idi = $(this).attr('nr_id');
                console.info('clicando desliga membro   '+idi);
                $('#itens').load("x-membresia/membresia_novo_popup.php?nrid="+idi);
        ...
        principal_membresia.html=function(){
    ...
    principal_membresia.start(); // EXECUTA A FUNCAO START NA ABERTURA DA PAGINA           
</script>