...
<script type="text/javascript">
    ...
    var mem_desligado = {};
    mem_desligado.arrayMembros=new Array();
    mem_desligado.start=function(){
        mem_desligado.html();
        mem_desligado.eventos(); // EXECUTA A FUNCAO EVENTOS, CONFIGURA OQUE OS CLIQUES IRÁ FAZER
       ...
       /* $('#bt_editar_membro').attr('nr_id',$("#nr_id").val());
        ...
        mem_desligado.setGridMembro();
    };

    mem_desligado.setGridMembro = function(){
        $('#tab_membro').find('tr').each( function(){
           ...
           //mem_desligado.arrayMembros.push( { id:id, nome: nome_membro } );
           mem_desligado.arrayMembros.push( obj );
        });
         var source = { localdata: mem_desligado.arrayMembros };
        ...
        mem_desligado.eventos=function(){
    ...
    mem_desligado.start(); // EXECUTA A FUNCAO START NA ABERTURA DA PAGINA
</script>