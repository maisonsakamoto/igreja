...
<script type="text/javascript">
    ...
    mem_desligar.start=function(){
      ...
      // });
        ...
        mem_desligar.eventos(); // EXECUTA A FUNCAO EVENTOS, CONFIGURA OQUE OS CLIQUES IRÁ FAZER
            $dialog.dialog({
            width: 540,
            height: 300,
            modal: true,
    ...
    mem_desligar.start(); // EXECUTA A FUNCAO START NA ABERTURA DA PAGINA
</script>