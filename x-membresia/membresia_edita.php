    ...
    while ($obj= mysqli_fetch_object($dt)) {
        ...
        $nascimento=$obj->nascimento;
            if (!empty($nascimento)) {
                ...
                if ($data_obj !== false) {
                    $nascimento = $data_obj->format('d/m/Y');}
                } else {$nascimento = '';}
        $membro_nasc_cidade = $obj->nascimento_cidade;
        $membro_nasc_estado = $obj->nascimento_estado;
        $membro_cep = $obj->endereco_cep;
        $membro_Endereco = $obj->endereco_rua;
        $membro_Endereco_Nr = $obj->endereco_numero;
        $membro_Endereco_Bairro = $obj->endereco_bairo;
        $membro_Endereco_Complemento = $obj->endereco_complemento;
        $membro_Endereco_Cidade = $obj->endereco_cidade;
        $membro_Endereco_Estado = $obj->endereco_estado;
        $membro_Estado_Civil = $obj->estado_civil;
        $membro_Grau_Instrucao = $obj->grau_instrucao;
        $membro_Telefone = $obj->telefone;
        $membro_Celular = $obj->celular;
        $membro_Email = $obj->email;
        $membro_Rede_social = $obj->rede_social;
        $membro_Conjuge = $obj->conjuge;
        $membro_Data_casamento = $obj->casamento;
            if (!empty($membro_Data_casamento)) {
                $data_obj = DateTime::createFromFormat('Y-m-d', $membro_Data_casamento);
                if ($data_obj !== false) {
                    $membro_Data_casamento = $data_obj->format('d/m/Y');}
                } else {$membro_Data_casamento = '';}
        $membro_Nome_Pai = $obj->nome_pai;
        $membro_Nome_Mae = $obj->nome_mae;
        $membro_Local_Trabalho = $obj->trabalho_local;
        $membro_Ramo_Trabalho = $obj->trabalho_ramo;
        $membro_BatisadoSN = $obj->batismo;
        $membro_Data_Batisado = $obj->batismo_data;
            if (!empty($membro_Data_Batisado)) {
                $data_obj = DateTime::createFromFormat('Y-m-d', $membro_Data_Batisado);
                if ($data_obj !== false) {
                    $membro_Data_Batisado = $data_obj->format('d/m/Y');}
                } else {$membro_Data_Batisado = '';}
        $membro_Batismo_Igreja = $obj->batismo_igreja;
        $membro_Batismo_Pastor = $obj->batismo_pastor;
        $membro_Batismo_Cidade = $obj->batismo_cidade;
        $membro_Batismo_Estado = $obj->batismo_estado;
        $membro_Tipo_Recebimento = $obj->uso_ibr_membresia;
        $membro_Data_Recebimento = $obj->uso_ibr_data;
            if (!empty($membro_Data_Recebimento)) {
                $data_obj = DateTime::createFromFormat('Y-m-d', $membro_Data_Recebimento);
                if ($data_obj !== false) {
                    $membro_Data_Recebimento = $data_obj->format('d/m/Y');}
                } else {$membro_Data_Recebimento = '';}
        $membro_Ata_Recebimento = $obj->uso_ibr_ata;
        $membro_Pastor_Recebimento = $obj->uso_ibr_pastor;
        $membro_Igreja_Recebimento = $obj->uso_ibr_igreja;
...
<div id="new_pop-up" class="ui-widget-content ui-corner-all pop-up" style="display: block;">
    ...
    <div1 style="width: 675px; border: 0px; padding-left: 1; " >
        ...
        <input  type="mem_nome" id="mem_nome" name="mem_nome" style="width: 455px;" maxlength="50" value="<?php echo $nome_membro; ?>">
        </fieldset>
        <fieldset  class="fieldsetnew" style="width:210px;">
            ...
            <input  type="mem_nascimento" id="mem_nascimento" name="mem_nascimento" alt="date" style="width: 210px" value="<?php echo $nascimento; ?>">  <!-- alt="date" coloca mascara de data, pega do jquery-meiomask.js -->
        </fieldset>
    </div1>
    ...
    <div2 style="width: 675px; border: 0px; padding-left: 1; " >
        ...
        <input  type="mem_nasc_cidade" id="mem_nasc_cidade" name="mem_nasc_cidade" style="width: 370px;" maxlength="30"value="<?php echo $membro_nasc_cidade; ?>">
        </fieldset>
        <fieldset  class="fieldsetnew" style="width:40px;">
            ...
            <input  type="mem_nasc_estado" id="mem_nasc_estado" name="mem_nasc_estado" maxlength="2" style="width: 60px;" value="<?php echo $membro_nasc_estado; ?>">
        </fieldset>
        <fieldset  class="fieldsetnew" style="width:208px;">
            ...
            <input  type="mem_endereco_cep" id="mem_endereco_cep" name="mem_endereco_cep" alt="cep" maxlength="12" style="width: 210px;" value="<?php echo $membro_cep; ?>">
        </fieldset>
    </div2>
    ...
    <div3 style="width: 675px; border: 0px; padding-left: 1; " >
        ...
        <fieldset class="fieldsetnew" style="width:310px;">
            ...
            <input  type="mem_endereco" id="mem_endereco" name="mem_endereco" style="width: 370px;" maxlength="50"  value="<?php echo $membro_Endereco; ?>">
        </fieldset>
        <fieldset  class="fieldsetnew" style="width:40px;">
            <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:30px;">Nr</legend>
            <input  type="mem_endereco_nr" id="mem_endereco_nr" name="mem_endereco_nr"  alt="numero"  style="width: 60px;" value="<?php echo $membro_Endereco_Nr; ?>"">
        </fieldset>
        <fieldset  class="fieldsetnew" style="width:208px;">
            <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:50px;">Bairro</legend>
            <input  type="mem_endereco_bairro" id="mem_endereco_bairro" name="mem_endereco_bairro"  maxlength="50" style="width: 210px;" maxlength="50" value="<?php echo $membro_Endereco_Bairro; ?>">
        </fieldset>
    </div3>
    ...
    <div4 style="width: 675px; border: 0px; padding-left: 1; " >
       ...
       <input  type="mem_endereco_complemento" id="mem_endereco_complemento" name="mem_endereco_complemento"  maxlength="50" style="width: 290px;" value="<?php echo $membro_Endereco_Complemento; ?>">
       </fieldset>
       <fieldset  class="fieldsetnew" style="width:290px;">
           <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:80px;">Cidade</legend>
           <input  type="mem_endereco_cidade" id="mem_endereco_cidade" name="mem_endereco_cidade"  maxlength="30" style="width: 290px;" value="<?php echo $membro_Endereco_Cidade; ?>"">
       </fieldset>
       <fieldset  class="fieldsetnew" style="width:60px;">
           <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:30px;">UF</legend>
           <input  type="mem_endereco_estado" id="mem_endereco_estado" name="mem_endereco_estado"  maxlength="2" style="width: 60px;" value="<?php echo $membro_Endereco_Estado; ?>">
        </fieldset>
...
<div5 style="width: 675px; border: 0px; padding-left: 1; " >
    ...
    <input type="mem_estado_civil" id="mem_estado_civil" name="mem_estado_civil"  maxlength="1" alt="numerounico" pattern="[12345]" oninput="validarEntradaestadocivil(event)"  style="width: 158px;"  value="<?php echo $membro_Estado_Civil; ?>">
    ...
    <fieldset  class="fieldsetnew tooltip" style="width:160px;">
        ...
        <input  type="mem_grau_instruao" id="mem_grau_instrucao" name="mem_grau_instruao"  maxlength="1" alt="numerounico" pattern="[123]" oninput="validarEntradaInstrucao(event)" style="width: 158px;" value="<?php echo $membro_Grau_Instrucao; ?>">
    ...
    <fieldset  class="fieldsetnew" style="width:145px;">
        ...
        <input  type="mem_telefone" id="mem_telefone" name="mem_telefone" alt="phone" maxlength="12" style="width: 144px;" value="<?php echo $membro_Telefone; ?>">
    </fieldset>
    <fieldset  class="fieldsetnew" style="width:145px;">
        <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:80px;">Celular</legend>
        <input  type="mem_celular" id="mem_celular" name="mem_celular" alt="celular" maxlength="12" maxlength="12" style="width: 144px;" value="<?php echo $membro_Celular; ?>">
    </fieldset>
...
<div6 style="width: 675px; border: 0px; padding-left: 1; " >
    ...
    <input  type="mem_email" id="mem_email" name="mem_email" maxlength="50" style="width: 335px;"  value="<?php echo $membro_Email; ?>">
    </fieldset>
    <fieldset  class="fieldsetnew" style="width:335px;">
        <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:80px;">Rede Social</legend>
        <input  type="mem_rede_social" id="mem_rede_social" name="mem_rede_social" maxlength="50" style="width: 335px;"  value="<?php echo $membro_Rede_social; ?>">
    </fieldset>
</div6>
...
<div7 style="width: 675px; border: 0px; padding-left: 1; " >
    ...
    <input  type="mem_conjuge" id="mem_conjuge" name="mem_conjuge" maxlength="50" style="width: 460px;"  value="<?php echo $membro_Conjuge; ?>">
    </fieldset>
    <fieldset  class="fieldsetnew" style="width:210px;">
        <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:110px;">Data Casamento</legend>
        <input  type="mem_casamento" id="mem_casamento" name="mem_casamento" alt="date" style="width: 210px;" value="<?php echo $membro_Data_casamento; ?>">
    </fieldset>
</div7>
...
<div8 style="width: 675px; border: 0px; padding-left: 1; " >
    ...
    <input  type="mem_nome_pai" id="mem_nome_pai" name="mem_nome_pai"maxlength="50" style="width: 335px;"  value="<?php echo $membro_Nome_Pai; ?>">
    </fieldset>
    <fieldset  class="fieldsetnew" style="width:335px;">
        <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:80px;">Nome Mãe</legend>
            <input  type="mem_nome_mae" id="mem_nome_mae" name="mem_nome_mae"maxlength="50" style="width: 335px;"  value="<?php echo $membro_Nome_Mae; ?>">
    </fieldset>
</div8>
...
<div9 style="width: 675px; border: 0px; padding-left: 1; " >
    ...
    <input  type="mem__trabalho_local" id="mem_trabalho_local" name="mem_trabalho_local" maxlength="50" style="width: 335px;"  value="<?php echo $membro_Local_Trabalho; ?>">
    </fieldset>
    <fieldset  class="fieldsetnew" style="width:335px;">
        <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:80px;">Ramo</legend>
        <input  type="mem__trabalho_ramo" id="mem_trabalho_ramo" name="mem_trabalho_ramo"maxlength="30" style="width: 335px;"  value="<?php echo $membro_Ramo_Trabalho; ?>">
    </fieldset>
</div9>
...
<div10 style="width: 675px; border: 0px; padding-left: 1; " >
    ...
    <fieldset  class="fieldsetgrupo" style="width:700px; height: 115px; ">
        ...
        <fieldset  class="fieldsetnew tooltip" style="width:95px;">
            ...
            <input  type="mem_batisao_nao_batizado" id="mem_batisao_nao_batizado" name="mem_batisao_nao_batizado"  maxlength="1" alt="numerounico" pattern="[12]" oninput="validarEntradaBatismo(event)" style="width: 100px;"  value="<?php echo $membro_BatisadoSN; ?>">
        ...
        <fieldset  class="fieldsetnew" style="width:150px;">
            ...
            <input  type="mem_dt_batismo" id="mem_dt_batismo" name="mem_dt_batismo" alt="date" style="width: 150px;"  value="<?php echo $membro_Data_Batisado; ?>">  <!-- alt="date" coloca mascara de data, pega do jquery-meiomask.js -->
        </fieldset>
        <fieldset  class="fieldsetnew" style="width:323px;">
            ...
            <input  type="mem_batismo_igreja" id="mem_batismo_igreja" name="mem_batismo_igreja"maxlength="50" style="width: 358px;" value="<?php echo $membro_Batismo_Igreja; ?>">
        </fieldset>
        <div style="height:1px;"> </div> <!--   */ espaço entre fieldsets -->
            ...
            <input  type="mem_batismo_pastor" id="mem_batismo_pastor" name="mem_batismo_pastor"maxlength="50" style="width: 322px;"  value="<?php echo $membro_Batismo_Pastor; ?>">
            </fieldset>
            <fieldset  class="fieldsetnew" style="width:210px;">
                <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:80px;">Cidade</legend>
                <input  type="mem_batismo_cidade" id="mem_batismo_cidade" name="mem_batismo_cidade"maxlength="50" style="width: 232px;"  value="<?php echo $membro_Batismo_Cidade; ?>">
            </fieldset>
            <fieldset  class="fieldsetnew" style="width:40px;">
                <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:30px;">UF</legend>
                <input  type="mem_batismo_estado" id="mem_batismo_estado" name="mem_batismo_estado"  maxlength="2" style="width: 60px;"  value="<?php echo $membro_Batismo_Estado; ?>">
            </fieldset>
        </fieldset>
    </fieldset>
</div10>
...
<div11 style="width: 675px; border: 0px; padding-left: 1; " >
    ...
    <fieldset class="fieldsetgrupo" style="width:700px; height: 115px;">
        ...
        <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:80px;" >Recebido </legend>
            <input type="mem_tipo_recebido" id="mem_tipo_recebido" name="mem_tipo_recebido"  maxlength="1" alt="numerounico" pattern="[1234]" oninput="validarEntradaMembresia(event)"  style="width: 204px;"  value="<?php echo $membro_Tipo_Recebimento; ?>">
        ...
        <input  type="mem_uso_ibr_data" id="mem_uso_ibr_data" name="mem_uso_ibr_data" alt="date" style="width: 204px;" value="<?php echo $membro_Data_Recebimento; ?>">  <!-- alt="date" coloca mascara de data, pega do jquery-meiomask.js -->
        </fieldset>
        <fieldset  class="fieldsetnew" style="width:175px;">
            <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:60px;">Ata</legend>
            <input  type="mem_ata_batismo" id="mem_ata_batismo" name="mem_ata_batismo"maxlength="50" style="width: 204px;" value="<?php echo $membro_Ata_Recebimento; ?>">
        </fieldset>
        ...
        <input  type="mem_uso_ibr_pastor" id="mem_uso_ibr_pastor" name="mem_uso_ibr_pastor"maxlength="50" style="width: 321px;" value="<?php echo $membro_Pastor_Recebimento; ?>">
        </fieldset>
        <fieldset  class="fieldsetnew" style="width:278px;">
            <legend  class="ui-widget ui-widget-header ui-corner-all" style="width:80px;">Igreja</legend>
            <input  type="mem_uso_ibr_igreja" id="mem_uso_ibr_igreja" name="mem_uso_ibr_igreja"maxlength="50" style="width: 321px;" value="<?php echo $membro_Igreja_Recebimento; ?>">
        </fieldset>
...
<script type="text/javascript">
    ...
    mem_edita.start=function(){
      ...
      // });
        ...
        mem_edita.eventos(); // EXECUTA A FUNCAO EVENTOS, CONFIGURA OQUE OS CLIQUES IRÁ FAZER
            $dialog.dialog({
            width: 760,
            height: 830,
            modal: true,
    ...
    //    // FIM DO FUNCIONAMENTO DO INPUT
            ...
            $('#bt_gravar').click(function(){
                ...
                console.info('Botao Gravar edita');
                ...
                var atualiza_infos='edita_membro';
                ...
                var url=("bd/atualiza_infos.php?id_membro="+id_membro+'&nome_membro='+membroNome+'&atualiza_contas='+atualiza_infos+
                ...
                //var url=("x-membresia/membresia_info.php?nrid="+id_membro);
                //$('#div2').load(url);
                //var url=("x-membresia/membresia.php?nrid="+id_membro);
                //$('#div_membros').load(url);
                //$('#div_membros').document.getElementById(url);
                //document.getElementById('div_membros');
                var url=("x-membresia/membresia_info.php?nrid="+id_membro);
                $('#itens').load(url);
            });
    ...
    mem_edita.start(); // EXECUTA A FUNCAO START NA ABERTURA DA PAGINA
</script>
