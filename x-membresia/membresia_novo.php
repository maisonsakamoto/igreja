...
<script type="text/javascript">
    ...
    mem_novo.start=function(){
      ...
      // });
        ...
        mem_novo.eventos(); // EXECUTA A FUNCAO EVENTOS, CONFIGURA OQUE OS CLIQUES IRÁ FAZER
            $dialog.dialog({
            width: 760,
            height: 830,
            modal: true,
    ...
    mem_novo.start(); // EXECUTA A FUNCAO START NA ABERTURA DA PAGINA
</script>